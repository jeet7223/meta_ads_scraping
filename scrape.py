...
if option_ans == "Y" or option_ans == "y":
    ...
    with open(filename, 'w', newline='', encoding="utf8") as csvfile:
        ...
        csvwriter.writerows([["Keyword","Page Name","Page Address","Email","Contact","Website Address","Address"]])
...
for item in keyword:
    url_array = []
    driver.get("https://www.facebook.com/ads/library/?active_status=all&ad_type=all&country=ALL&q={}&search_type=keyword_unordered&media_type=all&start_date[min]={}&start_date[max]=".format(item[0],configuration.start_date))
    ...
    if not configuration.testing_mode:
        _len = driver.find_elements(By.CLASS_NAME, "_99s5")
        ...
        while True:
            ...
            new_height = driver.find_elements(By.CLASS_NAME, "_99s5")
    ...
    try:
        data = driver.find_elements(By.CLASS_NAME, "_99s5")
    except:
        data = []
    ...
    for cards in data:
        ...
        try:
            ...
            card_url = ""
        if card_url in url_array:
            continue
        else:
            url_array.append(card_url)
            ...
            try:
                address = driver.find_element_by_xpath("//div[@class='l9j0dhe7 dhix69tm wkznzc2l p5pk11vy o9dbymsk j83agx80 kzx2olss aot14ch1 p86d2i9g beltcj47 o9q50ak6 j1vyfwqu jm7nytfl rg76wyzq tdjehn4e']").find_element_by_xpath("//div[@class='j83agx80 cbu4d94t sj5x9vvc cxgpxx05']").text
            except:
                address = None
            ...
            if email is None and contact_number is None and site_url is None:
                ...
                with open(filename, 'a', newline='', encoding="utf8") as csvfile:
                    ...
                    csvwriter = csv.writer(csvfile)
                    # writing the data rows
                    csvwriter.writerow([item[0],name, card_url, email, contact_number, site_url, address])
            counter = counter + 1
            driver.close()
            time.sleep(1)
